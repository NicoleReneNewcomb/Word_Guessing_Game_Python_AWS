...
# Description: Word guessing game that pulls
#   words from txt file then creates a
#   dictionary with word-length as key so
#   user can select word length/difficulty
#   and have a random word selected. Uses
#   ASCII art to display Winner/You Lost.
